...
public:
	...
	*/
	...
	void Value(CString &value) const;
...
public:
	...
	*/
	...
	void Attribute(const char* name,CString& value);
...
public:
	...
	*/
	...
	bool LoadFile(CString filename, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING);
