...
/////////////////////////////////////////////////////////////////////////////
// _ExApplication wrapper class
#pragma once

class _ExApplication : public COleDispatchDriver
{
public:
	_ExApplication() {}		// Calls COleDispatchDriver default constructor
	_ExApplication(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_ExApplication(const _ExApplication& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
/////////////////////////////////////////////////////////////////////////////
// _ExSheets wrapper class

class _ExSheets : public COleDispatchDriver
{
public:
	_ExSheets() {}		// Calls COleDispatchDriver default constructor
	_ExSheets(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_ExSheets(const _ExSheets& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	long GetCount();
	void Delete();
	void FillAcrossSheets(LPDISPATCH _ExRange, long Type);
...
/////////////////////////////////////////////////////////////////////////////
// _ExWindow wrapper class

class _ExWindow : public COleDispatchDriver
{
public:
	_ExWindow() {}		// Calls COleDispatchDriver default constructor
	_ExWindow(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_ExWindow(const _ExWindow& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	VARIANT ScrollWorkbookTabs(const VARIANT& _ExSheets, const VARIANT& Position);
...
/////////////////////////////////////////////////////////////////////////////
// _ExRange wrapper class

class _ExRange : public COleDispatchDriver
{
public:
	_ExRange() {}		// Calls COleDispatchDriver default constructor
	_ExRange(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_ExRange(const _ExRange& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	VARIANT AutoFit();
	VARIANT AutoFormat(long Format, const VARIANT& Number, const VARIANT& _ExFont, const VARIANT& Alignment, const VARIANT& Border, const VARIANT& Pattern, const VARIANT& Width);
	VARIANT AutoOutline();
...
class _ExStyle : public COleDispatchDriver
{
public:
	_ExStyle() {}		// Calls COleDispatchDriver default constructor
	_ExStyle(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_ExStyle(const _ExStyle& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
/////////////////////////////////////////////////////////////////////////////
// _ExStyles wrapper class

class _ExStyles : public COleDispatchDriver
{
public:
	_ExStyles() {}		// Calls COleDispatchDriver default constructor
	_ExStyles(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_ExStyles(const _ExStyles& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
class _ExFont : public COleDispatchDriver
{
public:
	_ExFont() {}		// Calls COleDispatchDriver default constructor
	_ExFont(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_ExFont(const _ExFont& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void PutBlackAndWhite(BOOL newValue);
	double GetBottomMargin();
	void PutBottomMargin(double newValue);
	CString GetCenterFooter();
	void PutCenterFooter(LPCTSTR newValue);
	CString GetCenterHeader();
	void PutCenterHeader(LPCTSTR newValue);
	BOOL GetCenterHorizontally();
	void PutCenterHorizontally(BOOL newValue);
	BOOL GetCenterVertically();
	void PutCenterVertically(BOOL newValue);
	long GetChartSize();
	void PutChartSize(long newValue);
	BOOL GetDraft();
	void PutDraft(BOOL newValue);
	long GetFirstPageNumber();
	void PutFirstPageNumber(long newValue);
	VARIANT GetFitToPagesTall();
	void PutFitToPagesTall(VARIANT& newValue);
	VARIANT GetFitToPagesWide();
	void PutFitToPagesWide(VARIANT& newValue);
	double GetFooterMargin();
	void PutFooterMargin(double newValue);
	double GetHeaderMargin();
	void PutHeaderMargin(double newValue);
	CString GetLeftFooter();
	void PutLeftFooter(LPCTSTR newValue);
	CString GetLeftHeader();
	void PutLeftHeader(LPCTSTR newValue);
	double GetLeftMargin();
	void PutLeftMargin(double newValue);
	long GetOrder();
	void PutOrder(long newValue);
	long GetOrientation();
	void PutOrientation(long newValue);
	long GetPaperSize();
	void PutPaperSize(long newValue);
	CString GetPrintArea();
	void PutPrintArea(LPCTSTR newValue);
	BOOL GetPrintGridlines();
	void PutPrintGridlines(BOOL newValue);
	BOOL GetPrintHeadings();
	void PutPrintHeadings(BOOL newValue);
	BOOL GetPrintNotes();
	void PutPrintNotes(BOOL newValue);
	VARIANT GetPrintQuality(VARIANT& Index);
	void PutPrintQuality(VARIANT& Index, VARIANT& newValue);
	CString GetPrintTitleColumns();
	void PutPrintTitleColumns(LPCTSTR newValue);
	CString GetPrintTitleRows();
	void PutPrintTitleRows(LPCTSTR newValue);
	CString GetRightFooter();
	void PutRightFooter(LPCTSTR newValue);
	CString GetRightHeader();
	void PutRightHeader(LPCTSTR newValue);
	double GetRightMargin();
	void PutRightMargin(double newValue);
	double GetTopMargin();
	void PutTopMargin(double newValue);
	VARIANT GetZoom();
	void PutZoom(VARIANT& newValue);
	long GetPrintComments();
	void PutPrintComments(long newValue);
	long GetPrintErrors();
	void PutPrintErrors(long newValue);
	...
	void PutOddAndEvenPagesHeaderFooter(BOOL newValue);
	BOOL GetDifferentFirstPageHeaderFooter();
	void PutDifferentFirstPageHeaderFooter(BOOL newValue);
	BOOL GetScaleWithDocHeaderFooter();
	void PutScaleWithDocHeaderFooter(BOOL newValue);
	BOOL GetAlignMarginsHeaderFooter();
	void PutAlignMarginsHeaderFooter(BOOL newValue);
	LPDISPATCH GetPages();
