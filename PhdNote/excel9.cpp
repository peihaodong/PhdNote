...
/////////////////////////////////////////////////////////////////////////////
// _ExApplication properties

long _ExApplication::GetHwnd()
{
	long result;
...
/////////////////////////////////////////////////////////////////////////////
// _ExApplication operations

LPDISPATCH _ExApplication::GetApplication()
{
	LPDISPATCH result;
...
long _ExApplication::GetCreator()
{
	long result;
...
LPDISPATCH _ExApplication::GetParent()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetActiveCell()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetActiveChart()
{
	LPDISPATCH result;
...
CString _ExApplication::GetActivePrinter()
{
	CString result;
...
void _ExApplication::SetActivePrinter(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
LPDISPATCH _ExApplication::GetActiveSheet()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetActiveWindow()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetActiveWorkbook()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetAddIns()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetAssistant()
{
	LPDISPATCH result;
...
void _ExApplication::Calculate()
{
	InvokeHelper(0x117, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

LPDISPATCH _ExApplication::GetCells()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetCharts()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetColumns()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetCommandBars()
{
	LPDISPATCH result;
...
long _ExApplication::GetDDEAppReturnCode()
{
	long result;
...
void _ExApplication::DDEExecute(long Channel, LPCTSTR String)
{
	static BYTE parms[] =
		VTS_I4 VTS_BSTR;
...
long _ExApplication::DDEInitiate(LPCTSTR App, LPCTSTR Topic)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR;
...
void _ExApplication::DDEPoke(long Channel, const VARIANT& Item, const VARIANT& Data)
{
	static BYTE parms[] =
...
VARIANT _ExApplication::DDERequest(long Channel, LPCTSTR Item)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_I4 VTS_BSTR;
...
void _ExApplication::DDETerminate(long Channel)
{
	static BYTE parms[] =
		VTS_I4;
...
VARIANT _ExApplication::Evaluate(const VARIANT& Name)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExApplication::_Evaluate(const VARIANT& Name)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExApplication::ExecuteExcel4Macro(LPCTSTR String)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_BSTR;
...
LPDISPATCH _ExApplication::Intersect(LPDISPATCH Arg1, LPDISPATCH Arg2, const VARIANT& Arg3, const VARIANT& Arg4, const VARIANT& Arg5, const VARIANT& Arg6, const VARIANT& Arg7, const VARIANT& Arg8, const VARIANT& Arg9, const VARIANT& Arg10, 
...
LPDISPATCH _ExApplication::GetNames()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetRange(const VARIANT& Cell1, const VARIANT& Cell2)
{
	LPDISPATCH result;
	static BYTE parms[] =
...
LPDISPATCH _ExApplication::GetRows()
{
	LPDISPATCH result;
...
VARIANT _ExApplication::Run(const VARIANT& Macro, const VARIANT& Arg1, const VARIANT& Arg2, const VARIANT& Arg3, const VARIANT& Arg4, const VARIANT& Arg5, const VARIANT& Arg6, const VARIANT& Arg7, const VARIANT& Arg8, const VARIANT& Arg9, 
...
VARIANT _ExApplication::_Run2(const VARIANT& Macro, const VARIANT& Arg1, const VARIANT& Arg2, const VARIANT& Arg3, const VARIANT& Arg4, const VARIANT& Arg5, const VARIANT& Arg6, const VARIANT& Arg7, const VARIANT& Arg8, const VARIANT& Arg9, 
		const VARIANT& Arg10, const VARIANT& Arg11, const VARIANT& Arg12, const VARIANT& Arg13, const VARIANT& Arg14, const VARIANT& Arg15, const VARIANT& Arg16, const VARIANT& Arg17, const VARIANT& Arg18, const VARIANT& Arg19, 
		const VARIANT& Arg20, const VARIANT& Arg21, const VARIANT& Arg22, const VARIANT& Arg23, const VARIANT& Arg24, const VARIANT& Arg25, const VARIANT& Arg26, const VARIANT& Arg27, const VARIANT& Arg28, const VARIANT& Arg29, 
		const VARIANT& Arg30)
{
...
LPDISPATCH _ExApplication::GetSelection()
{
	LPDISPATCH result;
...
void _ExApplication::SendKeys(const VARIANT& Keys, const VARIANT& Wait)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
LPDISPATCH _ExApplication::GetSheets()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetThisWorkbook()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::Union(LPDISPATCH Arg1, LPDISPATCH Arg2, const VARIANT& Arg3, const VARIANT& Arg4, const VARIANT& Arg5, const VARIANT& Arg6, const VARIANT& Arg7, const VARIANT& Arg8, const VARIANT& Arg9, const VARIANT& Arg10, const VARIANT& Arg11, 
...
LPDISPATCH _ExApplication::GetWindows()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetWorkbooks()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetWorksheetFunction()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetWorksheets()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetExcel4IntlMacroSheets()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetExcel4MacroSheets()
{
	LPDISPATCH result;
...
void _ExApplication::ActivateMicrosoftApp(long Index)
{
	static BYTE parms[] =
		VTS_I4;
...
void _ExApplication::AddChartAutoFormat(const VARIANT& Chart, LPCTSTR Name, const VARIANT& Description)
{
	static BYTE parms[] =
...
void _ExApplication::AddCustomList(const VARIANT& ListArray, const VARIANT& ByRow)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
BOOL _ExApplication::GetAlertBeforeOverwriting()
{
	BOOL result;
...
void _ExApplication::SetAlertBeforeOverwriting(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CString _ExApplication::GetAltStartupPath()
{
	CString result;
...
void _ExApplication::SetAltStartupPath(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
BOOL _ExApplication::GetAskToUpdateLinks()
{
	BOOL result;
...
void _ExApplication::SetAskToUpdateLinks(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetEnableAnimations()
{
	BOOL result;
...
void _ExApplication::SetEnableAnimations(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
LPDISPATCH _ExApplication::GetAutoCorrect()
{
	LPDISPATCH result;
...
BOOL _ExApplication::GetCalculateBeforeSave()
{
	BOOL result;
...
void _ExApplication::SetCalculateBeforeSave(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long _ExApplication::GetCalculation()
{
	long result;
...
void _ExApplication::SetCalculation(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
VARIANT _ExApplication::GetCaller(const VARIANT& Index)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
BOOL _ExApplication::GetCanPlaySounds()
{
	BOOL result;
...
BOOL _ExApplication::GetCanRecordSounds()
{
	BOOL result;
...
CString _ExApplication::GetCaption()
{
	CString result;
...
void _ExApplication::SetCaption(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
BOOL _ExApplication::GetCellDragAndDrop()
{
	BOOL result;
...
void _ExApplication::SetCellDragAndDrop(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
double _ExApplication::CentimetersToPoints(double Centimeters)
{
	double result;
	static BYTE parms[] =
		VTS_R8;
...
BOOL _ExApplication::CheckSpelling(LPCTSTR Word, const VARIANT& CustomDictionary, const VARIANT& IgnoreUppercase)
{
	BOOL result;
	static BYTE parms[] =
...
VARIANT _ExApplication::GetClipboardFormats(const VARIANT& Index)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
BOOL _ExApplication::GetDisplayClipboardWindow()
{
	BOOL result;
...
void _ExApplication::SetDisplayClipboardWindow(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long _ExApplication::GetCommandUnderlines()
{
	long result;
...
void _ExApplication::SetCommandUnderlines(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL _ExApplication::GetConstrainNumeric()
{
	BOOL result;
...
void _ExApplication::SetConstrainNumeric(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
VARIANT _ExApplication::ConvertFormula(const VARIANT& Formula, long FromReferenceStyle, const VARIANT& ToReferenceStyle, const VARIANT& ToAbsolute, const VARIANT& RelativeTo)
{
	VARIANT result;
	static BYTE parms[] =
...
BOOL _ExApplication::GetCopyObjectsWithCells()
{
	BOOL result;
...
void _ExApplication::SetCopyObjectsWithCells(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExApplication::SetCursor(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long _ExApplication::GetCustomListCount()
{
	long result;
...
long _ExApplication::GetCutCopyMode()
{
	long result;
...
void _ExApplication::SetCutCopyMode(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long _ExApplication::GetDataEntryMode()
{
	long result;
...
void _ExApplication::SetDataEntryMode(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CString _ExApplication::Get_Default()
{
	CString result;
...
CString _ExApplication::GetDefaultFilePath()
{
	CString result;
...
void _ExApplication::SetDefaultFilePath(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void _ExApplication::DeleteChartAutoFormat(LPCTSTR Name)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void _ExApplication::DeleteCustomList(long ListNum)
{
	static BYTE parms[] =
		VTS_I4;
...
LPDISPATCH _ExApplication::GetDialogs()
{
	LPDISPATCH result;
...
BOOL _ExApplication::GetDisplayAlerts()
{
	BOOL result;
...
void _ExApplication::SetDisplayAlerts(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetDisplayFormulaBar()
{
	BOOL result;
...
void _ExApplication::SetDisplayFormulaBar(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetDisplayFullScreen()
{
	BOOL result;
...
void _ExApplication::SetDisplayFullScreen(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetDisplayNoteIndicator()
{
	BOOL result;
...
void _ExApplication::SetDisplayNoteIndicator(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long _ExApplication::GetDisplayCommentIndicator()
{
	long result;
...
void _ExApplication::SetDisplayCommentIndicator(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL _ExApplication::GetDisplayExcel4Menus()
{
	BOOL result;
...
void _ExApplication::SetDisplayExcel4Menus(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetDisplayRecentFiles()
{
	BOOL result;
...
void _ExApplication::SetDisplayRecentFiles(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetDisplayScrollBars()
{
	BOOL result;
...
void _ExApplication::SetDisplayScrollBars(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetDisplayStatusBar()
{
	BOOL result;
...
void _ExApplication::SetDisplayStatusBar(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExApplication::DoubleClick()
{
	InvokeHelper(0x15d, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

BOOL _ExApplication::GetEditDirectlyInCell()
{
	BOOL result;
...
void _ExApplication::SetEditDirectlyInCell(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetEnableAutoComplete()
{
	BOOL result;
...
void _ExApplication::SetEnableAutoComplete(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long _ExApplication::GetEnableCancelKey()
{
	long result;
...
void _ExApplication::SetEnableCancelKey(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL _ExApplication::GetEnableSound()
{
	BOOL result;
...
void _ExApplication::SetEnableSound(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
VARIANT _ExApplication::GetFileConverters(const VARIANT& Index1, const VARIANT& Index2)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
LPDISPATCH _ExApplication::GetFileSearch()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetFileFind()
{
	LPDISPATCH result;
...
BOOL _ExApplication::GetFixedDecimal()
{
	BOOL result;
...
void _ExApplication::SetFixedDecimal(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long _ExApplication::GetFixedDecimalPlaces()
{
	long result;
...
void _ExApplication::SetFixedDecimalPlaces(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
VARIANT _ExApplication::GetCustomListContents(long ListNum)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_I4;
...
long _ExApplication::GetCustomListNum(const VARIANT& ListArray)
{
	long result;
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExApplication::GetOpenFilename(const VARIANT& FileFilter, const VARIANT& FilterIndex, const VARIANT& Title, const VARIANT& ButtonText, const VARIANT& MultiSelect)
{
	VARIANT result;
	static BYTE parms[] =
...
VARIANT _ExApplication::GetSaveAsFilename(const VARIANT& InitialFilename, const VARIANT& FileFilter, const VARIANT& FilterIndex, const VARIANT& Title, const VARIANT& ButtonText)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
void _ExApplication::Goto(const VARIANT& Reference, const VARIANT& Scroll)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
double _ExApplication::GetHeight()
{
	double result;
...
void _ExApplication::SetHeight(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
void _ExApplication::Help(const VARIANT& HelpFile, const VARIANT& HelpContextID)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
BOOL _ExApplication::GetIgnoreRemoteRequests()
{
	BOOL result;
...
void _ExApplication::SetIgnoreRemoteRequests(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
double _ExApplication::InchesToPoints(double Inches)
{
	double result;
	static BYTE parms[] =
		VTS_R8;
...
VARIANT _ExApplication::InputBox(LPCTSTR Prompt, const VARIANT& Title, const VARIANT& Default, const VARIANT& Left, const VARIANT& Top, const VARIANT& HelpFile, const VARIANT& HelpContextID, const VARIANT& Type)
{
	VARIANT result;
	static BYTE parms[] =
...
BOOL _ExApplication::GetInteractive()
{
	BOOL result;
...
void _ExApplication::SetInteractive(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
VARIANT _ExApplication::GetInternational(const VARIANT& Index)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
BOOL _ExApplication::GetIteration()
{
	BOOL result;
...
void _ExApplication::SetIteration(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExApplication::SetLeft(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
CString _ExApplication::GetLibraryPath()
{
	CString result;
...
void _ExApplication::MacroOptions(const VARIANT& Macro, const VARIANT& Description, const VARIANT& HasMenu, const VARIANT& MenuText, const VARIANT& HasShortcutKey, const VARIANT& ShortcutKey, const VARIANT& Category, const VARIANT& StatusBar, 
...
void _ExApplication::MailLogoff()
{
	InvokeHelper(0x3b1, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void _ExApplication::MailLogon(const VARIANT& Name, const VARIANT& Password, const VARIANT& DownloadNewMail)
{
	static BYTE parms[] =
...
VARIANT _ExApplication::GetMailSession()
{
	VARIANT result;
...
long _ExApplication::GetMailSystem()
{
	long result;
...
BOOL _ExApplication::GetMathCoprocessorAvailable()
{
	BOOL result;
...
double _ExApplication::GetMaxChange()
{
	double result;
...
void _ExApplication::SetMaxChange(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
long _ExApplication::GetMaxIterations()
{
	long result;
...
void _ExApplication::SetMaxIterations(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long _ExApplication::GetMemoryFree()
{
	long result;
...
long _ExApplication::GetMemoryTotal()
{
	long result;
...
long _ExApplication::GetMemoryUsed()
{
	long result;
...
BOOL _ExApplication::GetMouseAvailable()
{
	BOOL result;
...
BOOL _ExApplication::GetMoveAfterReturn()
{
	BOOL result;
...
void _ExApplication::SetMoveAfterReturn(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long _ExApplication::GetMoveAfterReturnDirection()
{
	long result;
...
void _ExApplication::SetMoveAfterReturnDirection(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
LPDISPATCH _ExApplication::GetRecentFiles()
{
	LPDISPATCH result;
...
CString _ExApplication::GetName()
{
	CString result;
...
LPDISPATCH _ExApplication::NextLetter()
{
	LPDISPATCH result;
...
CString _ExApplication::GetNetworkTemplatesPath()
{
	CString result;
...
LPDISPATCH _ExApplication::GetODBCErrors()
{
	LPDISPATCH result;
...
long _ExApplication::GetODBCTimeout()
{
	long result;
...
void _ExApplication::SetODBCTimeout(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void _ExApplication::OnKey(LPCTSTR Key, const VARIANT& Procedure)
{
	static BYTE parms[] =
...
void _ExApplication::OnRepeat(LPCTSTR Text, LPCTSTR Procedure)
{
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR;
...
void _ExApplication::OnTime(const VARIANT& EarliestTime, LPCTSTR Procedure, const VARIANT& LatestTime, const VARIANT& Schedule)
{
	static BYTE parms[] =
...
void _ExApplication::OnUndo(LPCTSTR Text, LPCTSTR Procedure)
{
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR;
...
CString _ExApplication::GetOnWindow()
{
	CString result;
...
void _ExApplication::SetOnWindow(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
CString _ExApplication::GetOperatingSystem()
{
	CString result;
...
CString _ExApplication::GetOrganizationName()
{
	CString result;
...
CString _ExApplication::GetPath()
{
	CString result;
...
CString _ExApplication::GetPathSeparator()
{
	CString result;
...
VARIANT _ExApplication::GetPreviousSelections(const VARIANT& Index)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
BOOL _ExApplication::GetPivotTableSelection()
{
	BOOL result;
...
void _ExApplication::SetPivotTableSelection(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetPromptForSummaryInfo()
{
	BOOL result;
...
void _ExApplication::SetPromptForSummaryInfo(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExApplication::Quit()
{
	InvokeHelper(0x12e, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void _ExApplication::RecordMacro(const VARIANT& BasicCode, const VARIANT& XlmCode)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
BOOL _ExApplication::GetRecordRelative()
{
	BOOL result;
...
long _ExApplication::GetReferenceStyle()
{
	long result;
...
void _ExApplication::SetReferenceStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
VARIANT _ExApplication::GetRegisteredFunctions(const VARIANT& Index1, const VARIANT& Index2)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
BOOL _ExApplication::RegisterXLL(LPCTSTR Filename)
{
	BOOL result;
	static BYTE parms[] =
		VTS_BSTR;
...
void _ExApplication::Repeat()
{
	InvokeHelper(0x12d, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

BOOL _ExApplication::GetRollZoom()
{
	BOOL result;
...
void _ExApplication::SetRollZoom(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExApplication::SaveWorkspace(const VARIANT& Filename)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
BOOL _ExApplication::GetScreenUpdating()
{
	BOOL result;
...
void _ExApplication::SetScreenUpdating(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExApplication::SetDefaultChart(const VARIANT& FormatName, const VARIANT& Gallery)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
long _ExApplication::GetSheetsInNewWorkbook()
{
	long result;
...
void _ExApplication::SetSheetsInNewWorkbook(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL _ExApplication::GetShowChartTipNames()
{
	BOOL result;
...
void _ExApplication::SetShowChartTipNames(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetShowChartTipValues()
{
	BOOL result;
...
void _ExApplication::SetShowChartTipValues(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CString _ExApplication::GetStandardFont()
{
	CString result;
...
void _ExApplication::SetStandardFont(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
double _ExApplication::GetStandardFontSize()
{
	double result;
...
void _ExApplication::SetStandardFontSize(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
CString _ExApplication::GetStartupPath()
{
	CString result;
...
VARIANT _ExApplication::GetStatusBar()
{
	VARIANT result;
...
void _ExApplication::SetStatusBar(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
CString _ExApplication::GetTemplatesPath()
{
	CString result;
...
BOOL _ExApplication::GetShowToolTips()
{
	BOOL result;
...
void _ExApplication::SetShowToolTips(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExApplication::SetTop(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
long _ExApplication::GetDefaultSaveFormat()
{
	long result;
...
void _ExApplication::SetDefaultSaveFormat(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CString _ExApplication::GetTransitionMenuKey()
{
	CString result;
...
void _ExApplication::SetTransitionMenuKey(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
long _ExApplication::GetTransitionMenuKeyAction()
{
	long result;
...
void _ExApplication::SetTransitionMenuKeyAction(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL _ExApplication::GetTransitionNavigKeys()
{
	BOOL result;
...
void _ExApplication::SetTransitionNavigKeys(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExApplication::Undo()
{
	InvokeHelper(0x12f, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

double _ExApplication::GetUsableHeight()
{
	double result;
...
double _ExApplication::GetUsableWidth()
{
	double result;
...
BOOL _ExApplication::GetUserControl()
{
	BOOL result;
...
void _ExApplication::SetUserControl(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CString _ExApplication::GetUserName_()
{
	CString result;
...
void _ExApplication::SetUserName(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
CString _ExApplication::GetValue()
{
	CString result;
...
LPDISPATCH _ExApplication::GetVbe()
{
	LPDISPATCH result;
...
CString _ExApplication::GetVersion()
{
	CString result;
...
BOOL _ExApplication::GetVisible()
{
	BOOL result;
...
void _ExApplication::SetVisible(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExApplication::Volatile(const VARIANT& Volatile)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
double _ExApplication::GetWidth()
{
	double result;
...
void _ExApplication::SetWidth(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
BOOL _ExApplication::GetWindowsForPens()
{
	BOOL result;
...
long _ExApplication::GetWindowState()
{
	long result;
...
void _ExApplication::SetWindowState(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long _ExApplication::GetDefaultSheetDirection()
{
	long result;
...
void _ExApplication::SetDefaultSheetDirection(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long _ExApplication::GetCursorMovement()
{
	long result;
...
void _ExApplication::SetCursorMovement(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL _ExApplication::GetControlCharacters()
{
	BOOL result;
...
void _ExApplication::SetControlCharacters(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::GetEnableEvents()
{
	BOOL result;
...
void _ExApplication::SetEnableEvents(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExApplication::Wait(const VARIANT& Time)
{
	BOOL result;
	static BYTE parms[] =
		VTS_VARIANT;
...
BOOL _ExApplication::GetExtendList()
{
	BOOL result;
...
void _ExApplication::SetExtendList(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
LPDISPATCH _ExApplication::GetOLEDBErrors()
{
	LPDISPATCH result;
...
CString _ExApplication::GetPhonetic(const VARIANT& Text)
{
	CString result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExApplication::GetCOMAddIns()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetDefaultWebOptions()
{
	LPDISPATCH result;
...
CString _ExApplication::GetProductCode()
{
	CString result;
...
CString _ExApplication::GetUserLibraryPath()
{
	CString result;
...
BOOL _ExApplication::GetAutoPercentEntry()
{
	BOOL result;
...
void _ExApplication::SetAutoPercentEntry(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
LPDISPATCH _ExApplication::GetLanguageSettings()
{
	LPDISPATCH result;
...
LPDISPATCH _ExApplication::GetAnswerWizard()
{
	LPDISPATCH result;
...
void _ExApplication::CalculateFull()
{
	InvokeHelper(0x70d, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

BOOL _ExApplication::FindFile()
{
	BOOL result;
...
long _ExApplication::GetCalculationVersion()
{
	long result;
...
BOOL _ExApplication::GetShowWindowsInTaskbar()
{
	BOOL result;
...
void _ExApplication::SetShowWindowsInTaskbar(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long _ExApplication::GetFeatureInstall()
{
	long result;
...
void _ExApplication::SetFeatureInstall(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
/////////////////////////////////////////////////////////////////////////////
// _ExSheets properties

/////////////////////////////////////////////////////////////////////////////
// _ExSheets operations

LPDISPATCH _ExSheets::GetApplication()
{
	LPDISPATCH result;
	InvokeHelper(0x94, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH _ExSheets::GetParent()
{
	LPDISPATCH result;
	InvokeHelper(0x96, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH _ExSheets::Add(const VARIANT& Before, const VARIANT& After, const VARIANT& Count, const VARIANT& Type)
{
	LPDISPATCH result;
	static BYTE parms[] =
...
void _ExSheets::Copy(const VARIANT& Before, const VARIANT& After)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
void _ExSheets::Delete()
{
	InvokeHelper(0x75, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void _ExSheets::FillAcrossSheets(LPDISPATCH _ExRange, long Type)
{
	static BYTE parms[] =
		VTS_DISPATCH VTS_I4;
...
LPDISPATCH _ExSheets::GetItem(const VARIANT& Index)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExSheets::Move(const VARIANT& Before, const VARIANT& After)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
LPUNKNOWN _ExSheets::Get_NewEnum()
{
	LPUNKNOWN result;
...
void _ExSheets::PrintPreview(const VARIANT& EnableChanges)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExSheets::Select(const VARIANT& Replace)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExSheets::GetHPageBreaks()
{
	LPDISPATCH result;
...
LPDISPATCH _ExSheets::GetVPageBreaks()
{
	LPDISPATCH result;
...
void _ExSheets::SetVisible(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0x22e, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
LPDISPATCH _ExSheets::Get_Default(const VARIANT& Index)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExSheets::PrintOut(const VARIANT& From, const VARIANT& To, const VARIANT& Copies, const VARIANT& Preview, const VARIANT& ActivePrinter, const VARIANT& PrintToFile, const VARIANT& Collate, const VARIANT& PrToFileName)
{
	static BYTE parms[] =
...
/////////////////////////////////////////////////////////////////////////////
// _ExWindow properties

/////////////////////////////////////////////////////////////////////////////
// _ExWindow operations

LPDISPATCH _ExWindow::GetApplication()
{
	LPDISPATCH result;
	InvokeHelper(0x94, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH _ExWindow::GetParent()
{
	LPDISPATCH result;
	InvokeHelper(0x96, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
VARIANT _ExWindow::ActivateNext()
{
	VARIANT result;
...
VARIANT _ExWindow::ActivatePrevious()
{
	VARIANT result;
...
LPDISPATCH _ExWindow::GetActiveCell()
{
	LPDISPATCH result;
	InvokeHelper(0x131, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH _ExWindow::GetActiveChart()
{
	LPDISPATCH result;
	InvokeHelper(0xb7, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH _ExWindow::GetActivePane()
{
	LPDISPATCH result;
...
LPDISPATCH _ExWindow::GetActiveSheet()
{
	LPDISPATCH result;
	InvokeHelper(0x133, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
void _ExWindow::SetCaption(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0x8b, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
BOOL _ExWindow::Close(const VARIANT& SaveChanges, const VARIANT& Filename, const VARIANT& RouteWorkbook)
{
	BOOL result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
BOOL _ExWindow::GetDisplayFormulas()
{
	BOOL result;
...
void _ExWindow::SetDisplayFormulas(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExWindow::GetDisplayGridlines()
{
	BOOL result;
...
void _ExWindow::SetDisplayGridlines(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExWindow::GetDisplayHeadings()
{
	BOOL result;
...
void _ExWindow::SetDisplayHeadings(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExWindow::GetDisplayHorizontalScrollBar()
{
	BOOL result;
...
void _ExWindow::SetDisplayHorizontalScrollBar(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExWindow::GetDisplayOutline()
{
	BOOL result;
...
void _ExWindow::SetDisplayOutline(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExWindow::GetDisplayVerticalScrollBar()
{
	BOOL result;
...
void _ExWindow::SetDisplayVerticalScrollBar(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExWindow::GetDisplayWorkbookTabs()
{
	BOOL result;
...
void _ExWindow::SetDisplayWorkbookTabs(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExWindow::GetDisplayZeros()
{
	BOOL result;
...
void _ExWindow::SetDisplayZeros(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _ExWindow::GetEnableResize()
{
	BOOL result;
...
void _ExWindow::SetEnableResize(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExWindow::SetFreezePanes(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long _ExWindow::GetGridlineColor()
{
	long result;
...
void _ExWindow::SetGridlineColor(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long _ExWindow::GetGridlineColorIndex()
{
	long result;
...
void _ExWindow::SetGridlineColorIndex(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void _ExWindow::SetHeight(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
	InvokeHelper(0x7b, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
VARIANT _ExWindow::LargeScroll(const VARIANT& Down, const VARIANT& Up, const VARIANT& ToRight, const VARIANT& ToLeft)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
void _ExWindow::SetLeft(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
	InvokeHelper(0x7f, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
LPDISPATCH _ExWindow::NewWindow()
{
	LPDISPATCH result;
	InvokeHelper(0x118, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
void _ExWindow::SetOnWindow(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
	InvokeHelper(0x26f, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
VARIANT _ExWindow::PrintOut(const VARIANT& From, const VARIANT& To, const VARIANT& Copies, const VARIANT& Preview, const VARIANT& ActivePrinter, const VARIANT& PrintToFile, const VARIANT& Collate, const VARIANT& PrToFileName)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExWindow::PrintPreview(const VARIANT& EnableChanges)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExWindow::GetRangeSelection()
{
	LPDISPATCH result;
...
long _ExWindow::GetScrollColumn()
{
	long result;
...
void _ExWindow::SetScrollColumn(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void _ExWindow::SetScrollRow(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
VARIANT _ExWindow::ScrollWorkbookTabs(const VARIANT& _ExSheets, const VARIANT& Position)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
LPDISPATCH _ExWindow::GetSelectedSheets()
{
	LPDISPATCH result;
...
LPDISPATCH _ExWindow::GetSelection()
{
	LPDISPATCH result;
	InvokeHelper(0x93, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
VARIANT _ExWindow::SmallScroll(const VARIANT& Down, const VARIANT& Up, const VARIANT& ToRight, const VARIANT& ToLeft)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
void _ExWindow::SetSplit(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _ExWindow::SetSplitColumn(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
double _ExWindow::GetSplitHorizontal()
{
	double result;
...
void _ExWindow::SetSplitHorizontal(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
void _ExWindow::SetSplitRow(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
double _ExWindow::GetSplitVertical()
{
	double result;
...
void _ExWindow::SetSplitVertical(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
void _ExWindow::SetTabRatio(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
void _ExWindow::SetTop(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
	InvokeHelper(0x7e, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
double _ExWindow::GetUsableHeight()
{
	double result;
	InvokeHelper(0x185, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, NULL);
	return result;
...
double _ExWindow::GetUsableWidth()
{
	double result;
	InvokeHelper(0x186, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, NULL);
	return result;
...
void _ExWindow::SetVisible(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
	InvokeHelper(0x22e, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
LPDISPATCH _ExWindow::GetVisibleRange()
{
	LPDISPATCH result;
...
void _ExWindow::SetWidth(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
	InvokeHelper(0x7a, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
long _ExWindow::GetWindowNumber()
{
	long result;
...
void _ExWindow::SetWindowState(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x18c, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
void _ExWindow::SetZoom(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExWindow::SetView(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL _ExWindow::GetDisplayRightToLeft()
{
	BOOL result;
	InvokeHelper(0x6ee, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
	return result;
...
void _ExWindow::SetDisplayRightToLeft(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
	InvokeHelper(0x6ee, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
long _ExWindow::PointsToScreenPixelsX(long Points)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long _ExWindow::PointsToScreenPixelsY(long Points)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
LPDISPATCH _ExWindow::RangeFromPoint(long x, long y)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_I4 VTS_I4;
...
void _ExWindow::ScrollIntoView(long Left, long Top, long Width, long Height, const VARIANT& Start)
{
	static BYTE parms[] =
...
LPDISPATCH _ExRange::GetApplication()
{
	LPDISPATCH result;
	InvokeHelper(0x94, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
void _ExRange::SetAddIndent(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
CString _ExRange::GetAddress(const VARIANT& RowAbsolute, const VARIANT& ColumnAbsolute, long ReferenceStyle, const VARIANT& External, const VARIANT& RelativeTo)
{
	CString result;
	static BYTE parms[] =
...
CString _ExRange::GetAddressLocal(const VARIANT& RowAbsolute, const VARIANT& ColumnAbsolute, long ReferenceStyle, const VARIANT& External, const VARIANT& RelativeTo)
{
	CString result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_I4 VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::AdvancedFilter(long Action, const VARIANT& CriteriaRange, const VARIANT& CopyToRange, const VARIANT& Unique)
{
	VARIANT result;
	static BYTE parms[] =
...
VARIANT _ExRange::ApplyNames(const VARIANT& Names, const VARIANT& IgnoreRelativeAbsolute, const VARIANT& UseRowColumnNames, const VARIANT& OmitColumn, const VARIANT& OmitRow, long Order, const VARIANT& AppendLast)
{
	VARIANT result;
	static BYTE parms[] =
...
VARIANT _ExRange::ApplyOutlineStyles()
{
	VARIANT result;
...
CString _ExRange::AutoComplete(LPCTSTR String)
{
	CString result;
	static BYTE parms[] =
		VTS_BSTR;
...
VARIANT _ExRange::AutoFill(LPDISPATCH Destination, long Type)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_DISPATCH VTS_I4;
...
VARIANT _ExRange::AutoFilter(const VARIANT& Field, const VARIANT& Criteria1, long Operator, const VARIANT& Criteria2, const VARIANT& VisibleDropDown)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_I4 VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::AutoFormat(long Format, const VARIANT& Number, const VARIANT& _ExFont, const VARIANT& Alignment, const VARIANT& Border, const VARIANT& Pattern, const VARIANT& Width)
{
	VARIANT result;
	static BYTE parms[] =
	...
	InvokeHelper(0x72, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		Format, &Number, &_ExFont, &Alignment, &Border, &Pattern, &Width);
	return result;
}

VARIANT _ExRange::AutoOutline()
{
	VARIANT result;
...
VARIANT _ExRange::BorderAround(const VARIANT& LineStyle, long Weight, long ColorIndex, const VARIANT& Color)
{
	VARIANT result;
	static BYTE parms[] =
...
LPDISPATCH _ExRange::GetBorders()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::GetCharacters(const VARIANT& Start, const VARIANT& Length)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::CheckSpelling(const VARIANT& CustomDictionary, const VARIANT& IgnoreUppercase, const VARIANT& AlwaysSuggest, const VARIANT& SpellLang)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::ClearContents()
{
	VARIANT result;
...
LPDISPATCH _ExRange::ColumnDifferences(const VARIANT& Comparison)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExRange::GetColumns()
{
	LPDISPATCH result;
	InvokeHelper(0xf1, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
VARIANT _ExRange::GetColumnWidth()
{
	VARIANT result;
...
void _ExRange::SetColumnWidth(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::Consolidate(const VARIANT& Sources, const VARIANT& Function, const VARIANT& TopRow, const VARIANT& LeftColumn, const VARIANT& CreateLinks)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::Copy(const VARIANT& Destination)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
long _ExRange::CopyFromRecordset(LPUNKNOWN Data, const VARIANT& MaxRows, const VARIANT& MaxColumns)
{
	long result;
	static BYTE parms[] =
...
VARIANT _ExRange::CopyPicture(long Appearance, long Format)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_I4 VTS_I4;
...
VARIANT _ExRange::CreateNames(const VARIANT& Top, const VARIANT& Left, const VARIANT& Bottom, const VARIANT& Right)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::CreatePublisher(const VARIANT& Edition, long Appearance, const VARIANT& ContainsPICT, const VARIANT& ContainsBIFF, const VARIANT& ContainsRTF, const VARIANT& ContainsVALU)
{
	VARIANT result;
	static BYTE parms[] =
...
LPDISPATCH _ExRange::GetCurrentArray()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::GetCurrentRegion()
{
	LPDISPATCH result;
...
VARIANT _ExRange::Cut(const VARIANT& Destination)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::DataSeries(const VARIANT& Rowcol, long Type, long Date, const VARIANT& Step, const VARIANT& Stop, const VARIANT& Trend)
{
	VARIANT result;
	static BYTE parms[] =
...
VARIANT _ExRange::Get_Default(const VARIANT& RowIndex, const VARIANT& ColumnIndex)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
void _ExRange::Set_Default(const VARIANT& RowIndex, const VARIANT& ColumnIndex, const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::Delete(const VARIANT& Shift)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExRange::GetDependents()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::GetDirectDependents()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::GetDirectPrecedents()
{
	LPDISPATCH result;
...
VARIANT _ExRange::EditionOptions(long Type, long Option, const VARIANT& Name, const VARIANT& Reference, long Appearance, long ChartSize, const VARIANT& Format)
{
	VARIANT result;
	static BYTE parms[] =
...
LPDISPATCH _ExRange::GetEnd(long Direction)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_I4;
...
LPDISPATCH _ExRange::GetEntireColumn()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::GetEntireRow()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::Find(const VARIANT& What, const VARIANT& After, const VARIANT& LookIn, const VARIANT& LookAt, const VARIANT& SearchOrder, long SearchDirection, const VARIANT& MatchCase, const VARIANT& MatchByte)
{
	LPDISPATCH result;
	static BYTE parms[] =
...
LPDISPATCH _ExRange::FindNext(const VARIANT& After)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExRange::FindPrevious(const VARIANT& After)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExRange::SetFormula(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetFormulaArray()
{
	VARIANT result;
...
void _ExRange::SetFormulaArray(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExRange::SetFormulaLabel(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
VARIANT _ExRange::GetFormulaHidden()
{
	VARIANT result;
...
void _ExRange::SetFormulaHidden(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetFormulaLocal()
{
	VARIANT result;
...
void _ExRange::SetFormulaLocal(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetFormulaR1C1()
{
	VARIANT result;
...
void _ExRange::SetFormulaR1C1(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetFormulaR1C1Local()
{
	VARIANT result;
...
void _ExRange::SetFormulaR1C1Local(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::FunctionWizard()
{
	VARIANT result;
...
BOOL _ExRange::GoalSeek(const VARIANT& Goal, LPDISPATCH ChangingCell)
{
	BOOL result;
	static BYTE parms[] =
...
VARIANT _ExRange::Group(const VARIANT& Start, const VARIANT& End, const VARIANT& By, const VARIANT& Periods)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::GetHasFormula()
{
	VARIANT result;
...
void _ExRange::SetHidden(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetHorizontalAlignment()
{
	VARIANT result;
...
void _ExRange::SetHorizontalAlignment(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetIndentLevel()
{
	VARIANT result;
...
void _ExRange::SetIndentLevel(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExRange::InsertIndent(long InsertAmount)
{
	static BYTE parms[] =
		VTS_I4;
...
VARIANT _ExRange::Insert(const VARIANT& Shift)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExRange::GetInterior()
{
	LPDISPATCH result;
...
VARIANT _ExRange::GetItem(const VARIANT& RowIndex, const VARIANT& ColumnIndex)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
void _ExRange::SetItem(const VARIANT& RowIndex, const VARIANT& ColumnIndex, const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
long _ExRange::GetListHeaderRows()
{
	long result;
...
long _ExRange::GetLocationInTable()
{
	long result;
...
void _ExRange::SetLocked(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExRange::Merge(const VARIANT& Across)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExRange::UnMerge()
{
	InvokeHelper(0x568, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

LPDISPATCH _ExRange::GetMergeArea()
{
	LPDISPATCH result;
...
VARIANT _ExRange::GetMergeCells()
{
	VARIANT result;
...
void _ExRange::SetMergeCells(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExRange::SetName(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0x6e, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
VARIANT _ExRange::NavigateArrow(const VARIANT& TowardPrecedent, const VARIANT& ArrowNumber, const VARIANT& LinkNumber)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
LPUNKNOWN _ExRange::Get_NewEnum()
{
	LPUNKNOWN result;
	InvokeHelper(0xfffffffc, DISPATCH_PROPERTYGET, VT_UNKNOWN, (void*)&result, NULL);
	return result;
...
CString _ExRange::NoteText(const VARIANT& Text, const VARIANT& Start, const VARIANT& Length)
{
	CString result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::GetNumberFormat()
{
	VARIANT result;
...
void _ExRange::SetNumberFormat(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetNumberFormatLocal()
{
	VARIANT result;
...
void _ExRange::SetNumberFormatLocal(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExRange::GetOffset(const VARIANT& RowOffset, const VARIANT& ColumnOffset)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::GetOrientation()
{
	VARIANT result;
...
void _ExRange::SetOrientation(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetOutlineLevel()
{
	VARIANT result;
...
void _ExRange::SetOutlineLevel(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExRange::SetPageBreak(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
VARIANT _ExRange::Parse(const VARIANT& ParseLine, const VARIANT& Destination)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::PasteSpecial(long Paste, long Operation, const VARIANT& SkipBlanks, const VARIANT& Transpose)
{
	VARIANT result;
	static BYTE parms[] =
...
LPDISPATCH _ExRange::GetPivotField()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::GetPivotItem()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::GetPivotTable()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::GetPrecedents()
{
	LPDISPATCH result;
...
VARIANT _ExRange::GetPrefixCharacter()
{
	VARIANT result;
...
LPDISPATCH _ExRange::GetPrevious()
{
	LPDISPATCH result;
	InvokeHelper(0x1f7, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
VARIANT _ExRange::_PrintOut(const VARIANT& From, const VARIANT& To, const VARIANT& Copies, const VARIANT& Preview, const VARIANT& ActivePrinter, const VARIANT& PrintToFile, const VARIANT& Collate)
{
	VARIANT result;
	static BYTE parms[] =
...
VARIANT _ExRange::PrintPreview(const VARIANT& EnableChanges)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExRange::GetQueryTable()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::GetRange(const VARIANT& Cell1, const VARIANT& Cell2)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::RemoveSubtotal()
{
	VARIANT result;
...
BOOL _ExRange::Replace(const VARIANT& What, const VARIANT& Replacement, const VARIANT& LookAt, const VARIANT& SearchOrder, const VARIANT& MatchCase, const VARIANT& MatchByte)
{
	BOOL result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
LPDISPATCH _ExRange::GetResize(const VARIANT& RowSize, const VARIANT& ColumnSize)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
LPDISPATCH _ExRange::RowDifferences(const VARIANT& Comparison)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExRange::SetRowHeight(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::Run(const VARIANT& Arg1, const VARIANT& Arg2, const VARIANT& Arg3, const VARIANT& Arg4, const VARIANT& Arg5, const VARIANT& Arg6, const VARIANT& Arg7, const VARIANT& Arg8, const VARIANT& Arg9, const VARIANT& Arg10, 
		const VARIANT& Arg11, const VARIANT& Arg12, const VARIANT& Arg13, const VARIANT& Arg14, const VARIANT& Arg15, const VARIANT& Arg16, const VARIANT& Arg17, const VARIANT& Arg18, const VARIANT& Arg19, const VARIANT& Arg20, 
		const VARIANT& Arg21, const VARIANT& Arg22, const VARIANT& Arg23, const VARIANT& Arg24, const VARIANT& Arg25, const VARIANT& Arg26, const VARIANT& Arg27, const VARIANT& Arg28, const VARIANT& Arg29, const VARIANT& Arg30)
{
	VARIANT result;
...
VARIANT _ExRange::ShowDependents(const VARIANT& Remove)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetShowDetail()
{
	VARIANT result;
...
void _ExRange::SetShowDetail(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::ShowPrecedents(const VARIANT& Remove)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetShrinkToFit()
{
	VARIANT result;
...
void _ExRange::SetShrinkToFit(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::Sort(const VARIANT& Key1, long Order1, const VARIANT& Key2, const VARIANT& Type, long Order2, const VARIANT& Key3, long Order3, long Header, const VARIANT& OrderCustom, const VARIANT& MatchCase, long Orientation, long SortMethod)
{
	VARIANT result;
	static BYTE parms[] =
...
VARIANT _ExRange::SortSpecial(long SortMethod, const VARIANT& Key1, long Order1, const VARIANT& Type, const VARIANT& Key2, long Order2, const VARIANT& Key3, long Order3, long Header, const VARIANT& OrderCustom, const VARIANT& MatchCase, 
		long Orientation)
{
	VARIANT result;
	static BYTE parms[] =
...
LPDISPATCH _ExRange::GetSoundNote()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::SpecialCells(long Type, const VARIANT& Value)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_I4 VTS_VARIANT;
...
void _ExRange::SetStyle(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::SubscribeTo(LPCTSTR Edition, long Format)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_BSTR VTS_I4;
...
VARIANT _ExRange::Subtotal(long GroupBy, long Function, const VARIANT& TotalList, const VARIANT& Replace, const VARIANT& PageBreaks, long SummaryBelowData)
{
	VARIANT result;
	static BYTE parms[] =
...
VARIANT _ExRange::Table(const VARIANT& RowInput, const VARIANT& ColumnInput)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExRange::TextToColumns(const VARIANT& Destination, long DataType, long TextQualifier, const VARIANT& ConsecutiveDelimiter, const VARIANT& Tab, const VARIANT& Semicolon, const VARIANT& Comma, const VARIANT& Space, const VARIANT& Other, 
...
VARIANT _ExRange::GetUseStandardHeight()
{
	VARIANT result;
...
void _ExRange::SetUseStandardHeight(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetUseStandardWidth()
{
	VARIANT result;
...
void _ExRange::SetUseStandardWidth(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExRange::GetValidation()
{
	LPDISPATCH result;
...
void _ExRange::SetValue(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExRange::SetValue2(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExRange::GetVerticalAlignment()
{
	VARIANT result;
...
void _ExRange::SetVerticalAlignment(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExRange::GetWorksheet()
{
	LPDISPATCH result;
...
void _ExRange::SetWrapText(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExRange::AddComment(const VARIANT& Text)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _ExRange::GetComment()
{
	LPDISPATCH result;
...
void _ExRange::ClearComments()
{
	InvokeHelper(0x56e, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

LPDISPATCH _ExRange::GetPhonetic()
{
	LPDISPATCH result;
...
LPDISPATCH _ExRange::GetFormatConditions()
{
	LPDISPATCH result;
...
void _ExRange::SetReadingOrder(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
LPDISPATCH _ExRange::GetHyperlinks()
{
	LPDISPATCH result;
	InvokeHelper(0x571, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH _ExRange::GetPhonetics()
{
	LPDISPATCH result;
...
void _ExRange::SetId(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
VARIANT _ExRange::PrintOut(const VARIANT& From, const VARIANT& To, const VARIANT& Copies, const VARIANT& Preview, const VARIANT& ActivePrinter, const VARIANT& PrintToFile, const VARIANT& Collate, const VARIANT& PrToFileName)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
...
void _ExStyle::SetAddIndent(const VARIANT& propVal)
{
	SetProperty(0x427, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetCreator()
{
	VARIANT result;
...
void _ExStyle::SetCreator(const VARIANT& propVal)
{
	SetProperty(0x95, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetFont()
{
	VARIANT result;
...
void _ExStyle::SetFont(const VARIANT& propVal)
{
	SetProperty(0x92, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetFormulaHidden()
{
	VARIANT result;
...
void _ExStyle::SetFormulaHidden(const VARIANT& propVal)
{
	SetProperty(0x106, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetHorizontalAlignment()
{
	VARIANT result;
...
void _ExStyle::SetHorizontalAlignment(const VARIANT& propVal)
{
	SetProperty(0x88, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetIncludeAlignment()
{
	VARIANT result;
...
void _ExStyle::SetIncludeAlignment(const VARIANT& propVal)
{
	SetProperty(0x19d, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetIncludeBorder()
{
	VARIANT result;
...
void _ExStyle::SetIncludeBorder(const VARIANT& propVal)
{
	SetProperty(0x19e, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetIncludeFont()
{
	VARIANT result;
...
void _ExStyle::SetIncludeFont(const VARIANT& propVal)
{
	SetProperty(0x19f, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetIncludeNumber()
{
	VARIANT result;
...
void _ExStyle::SetIncludeNumber(const VARIANT& propVal)
{
	SetProperty(0x1a0, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetIncludePatterns()
{
	VARIANT result;
...
void _ExStyle::SetIncludePatterns(const VARIANT& propVal)
{
	SetProperty(0x1a1, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetIncludeProtection()
{
	VARIANT result;
...
void _ExStyle::SetIncludeProtection(const VARIANT& propVal)
{
	SetProperty(0x1a2, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetInterior()
{
	VARIANT result;
...
void _ExStyle::SetInterior(const VARIANT& propVal)
{
	SetProperty(0x81, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetLocked()
{
	VARIANT result;
...
void _ExStyle::SetLocked(const VARIANT& propVal)
{
	SetProperty(0x10d, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetName()
{
	VARIANT result;
...
void _ExStyle::SetName(const VARIANT& propVal)
{
	SetProperty(0x6e, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetNameLocal()
{
	VARIANT result;
...
void _ExStyle::SetNameLocal(const VARIANT& propVal)
{
	SetProperty(0x3a9, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetNumberFormat()
{
	VARIANT result;
...
void _ExStyle::SetNumberFormat(const VARIANT& propVal)
{
	SetProperty(0xc1, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetNumberFormatLocal()
{
	VARIANT result;
...
void _ExStyle::SetNumberFormatLocal(const VARIANT& propVal)
{
	SetProperty(0x449, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetOrientation()
{
	VARIANT result;
...
void _ExStyle::SetOrientation(const VARIANT& propVal)
{
	SetProperty(0x86, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetParent()
{
	VARIANT result;
...
void _ExStyle::SetParent(const VARIANT& propVal)
{
	SetProperty(0x96, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetValue()
{
	VARIANT result;
...
void _ExStyle::SetValue(const VARIANT& propVal)
{
	SetProperty(0x6, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetVerticalAlignment()
{
	VARIANT result;
...
void _ExStyle::SetVerticalAlignment(const VARIANT& propVal)
{
	SetProperty(0x89, VT_VARIANT, &propVal);
}

VARIANT _ExStyle::GetWrapText()
{
	VARIANT result;
...
void _ExStyle::SetWrapText(const VARIANT& propVal)
{
...
VARIANT _ExStyle::Borders(const VARIANT& Index)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
/////////////////////////////////////////////////////////////////////////////
// _ExStyles properties

VARIANT _ExStyles::GetCount()
{
	VARIANT result;
...
void _ExStyles::SetCount(const VARIANT& propVal)
{
	SetProperty(0x76, VT_VARIANT, &propVal);
}

VARIANT _ExStyles::GetCreator()
{
	VARIANT result;
	GetProperty(0x95, VT_VARIANT, (void*)&result);
	return result;
...
void _ExStyles::SetCreator(const VARIANT& propVal)
{
	SetProperty(0x95, VT_VARIANT, &propVal);
}

VARIANT _ExStyles::GetParent()
{
	VARIANT result;
	GetProperty(0x96, VT_VARIANT, (void*)&result);
	return result;
...
void _ExStyles::SetParent(const VARIANT& propVal)
{
	SetProperty(0x96, VT_VARIANT, &propVal);
}

/////////////////////////////////////////////////////////////////////////////
// _ExStyles operations

VARIANT _ExStyles::_NewEnum()
{
	VARIANT result;
...
VARIANT _ExStyles::Add(const VARIANT& Name, const VARIANT& BasedOn)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
VARIANT _ExStyles::Item(const VARIANT& Index)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT _ExStyles::Merge(const VARIANT& Workbook)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT;
...
void _ExFont::SetBackground(const VARIANT& propVal)
{
	SetProperty(0xb4, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetBold()
{
	VARIANT result;
...
void _ExFont::SetBold(const VARIANT& propVal)
{
	SetProperty(0x60, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetColor()
{
	VARIANT result;
...
void _ExFont::SetColor(const VARIANT& propVal)
{
	SetProperty(0x63, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetColorIndex()
{
	VARIANT result;
...
void _ExFont::SetColorIndex(const VARIANT& propVal)
{
	SetProperty(0x61, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetCreator()
{
	VARIANT result;
	GetProperty(0x95, VT_VARIANT, (void*)&result);
	return result;
...
void _ExFont::SetCreator(const VARIANT& propVal)
{
	SetProperty(0x95, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetFontStyle()
{
	VARIANT result;
...
void _ExFont::SetFontStyle(const VARIANT& propVal)
{
	SetProperty(0xb1, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetItalic()
{
	VARIANT result;
...
void _ExFont::SetItalic(const VARIANT& propVal)
{
	SetProperty(0x65, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetName()
{
	VARIANT result;
	GetProperty(0x6e, VT_VARIANT, (void*)&result);
	return result;
...
void _ExFont::SetName(const VARIANT& propVal)
{
	SetProperty(0x6e, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetOutlineFont()
{
	VARIANT result;
...
void _ExFont::SetOutlineFont(const VARIANT& propVal)
{
	SetProperty(0xdd, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetParent()
{
	VARIANT result;
	GetProperty(0x96, VT_VARIANT, (void*)&result);
	return result;
...
void _ExFont::SetParent(const VARIANT& propVal)
{
	SetProperty(0x96, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetShadow()
{
	VARIANT result;
...
void _ExFont::SetShadow(const VARIANT& propVal)
{
	SetProperty(0x67, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetSize()
{
	VARIANT result;
...
void _ExFont::SetSize(const VARIANT& propVal)
{
	SetProperty(0x68, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetStrikethrough()
{
	VARIANT result;
...
void _ExFont::SetStrikethrough(const VARIANT& propVal)
{
	SetProperty(0x69, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetSubscript()
{
	VARIANT result;
...
void _ExFont::SetSubscript(const VARIANT& propVal)
{
	SetProperty(0xb3, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetSuperscript()
{
	VARIANT result;
...
void _ExFont::SetSuperscript(const VARIANT& propVal)
{
	SetProperty(0xb2, VT_VARIANT, &propVal);
}

VARIANT _ExFont::GetUnderline()
{
	VARIANT result;
...
void _ExFont::SetUnderline(const VARIANT& propVal)
{
...
void PageSetup::PutBlackAndWhite(BOOL newValue)
{
...
{
	double result;
	InvokeHelper(0x3ea, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutBottomMargin(double newValue)
{
	static BYTE parms[] = VTS_R8;
	InvokeHelper(0x3ea, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

CString PageSetup::GetCenterFooter()
{
	CString result;
	InvokeHelper(0x3f2, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutCenterFooter(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR;
	InvokeHelper(0x3f2, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

CString PageSetup::GetCenterHeader()
{
	CString result;
	InvokeHelper(0x3f3, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutCenterHeader(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR;
	InvokeHelper(0x3f3, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

BOOL PageSetup::GetCenterHorizontally()
{
	BOOL result;
	InvokeHelper(0x3ed, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutCenterHorizontally(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL;
	InvokeHelper(0x3ed, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

BOOL PageSetup::GetCenterVertically()
{
	BOOL result;
	InvokeHelper(0x3ee, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutCenterVertically(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL;
	InvokeHelper(0x3ee, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}
...
void PageSetup::PutChartSize(long newValue)
{
...
{
	BOOL result;
	InvokeHelper(0x3fc, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutDraft(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL;
	InvokeHelper(0x3fc, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

long PageSetup::GetFirstPageNumber()
{
	long result;
	InvokeHelper(0x3f0, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutFirstPageNumber(long newValue)
{
	static BYTE parms[] = VTS_I4;
...
{
	VARIANT result;
	InvokeHelper(0x3f5, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutFitToPagesTall(VARIANT& newValue)
{
...
{
	VARIANT result;
	InvokeHelper(0x3f6, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutFitToPagesWide(VARIANT& newValue)
{
	static BYTE parms[] = VTS_VARIANT;
	InvokeHelper(0x3f6, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, &newValue);
}

double PageSetup::GetFooterMargin()
{
	double result;
	InvokeHelper(0x3f7, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutFooterMargin(double newValue)
{
	static BYTE parms[] = VTS_R8;
	InvokeHelper(0x3f7, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

double PageSetup::GetHeaderMargin()
{
	double result;
	InvokeHelper(0x3f8, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutHeaderMargin(double newValue)
{
	static BYTE parms[] = VTS_R8;
	InvokeHelper(0x3f8, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

CString PageSetup::GetLeftFooter()
{
	CString result;
	InvokeHelper(0x3f9, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutLeftFooter(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR;
	InvokeHelper(0x3f9, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

CString PageSetup::GetLeftHeader()
{
	CString result;
	InvokeHelper(0x3fa, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutLeftHeader(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR;
	InvokeHelper(0x3fa, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

double PageSetup::GetLeftMargin()
{
	double result;
	InvokeHelper(0x3e7, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutLeftMargin(double newValue)
{
	static BYTE parms[] = VTS_R8;
	InvokeHelper(0x3e7, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

long PageSetup::GetOrder()
{
	long result;
	InvokeHelper(0xc0, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutOrder(long newValue)
{
	static BYTE parms[] = VTS_I4;
...
void PageSetup::PutOrientation(long newValue)
{
	static BYTE parms[] = VTS_I4;
...
{
	long result;
	InvokeHelper(0x3ef, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutPaperSize(long newValue)
{
	static BYTE parms[] = VTS_I4;
...
{
	CString result;
	InvokeHelper(0x3fb, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutPrintArea(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR;
	InvokeHelper(0x3fb, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

BOOL PageSetup::GetPrintGridlines()
{
	BOOL result;
	InvokeHelper(0x3ec, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutPrintGridlines(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL;
	InvokeHelper(0x3ec, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

BOOL PageSetup::GetPrintHeadings()
{
	BOOL result;
	InvokeHelper(0x3eb, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutPrintHeadings(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL;
...
{
	BOOL result;
	InvokeHelper(0x3fd, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutPrintNotes(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL;
	InvokeHelper(0x3fd, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

VARIANT PageSetup::GetPrintQuality(VARIANT& Index)
{
	VARIANT result;
	static BYTE parms[] = VTS_VARIANT;
...
void PageSetup::PutPrintQuality(VARIANT& Index, VARIANT& newValue)
{
	static BYTE parms[] = VTS_VARIANT VTS_VARIANT;
	InvokeHelper(0x3fe, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, &Index, &newValue);
}

CString PageSetup::GetPrintTitleColumns()
{
	CString result;
	InvokeHelper(0x3ff, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutPrintTitleColumns(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR;
	InvokeHelper(0x3ff, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}
...
void PageSetup::PutPrintTitleRows(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR;
	InvokeHelper(0x400, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}
...
void PageSetup::PutRightFooter(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR;
	InvokeHelper(0x401, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

CString PageSetup::GetRightHeader()
{
	CString result;
	InvokeHelper(0x402, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutRightHeader(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR;
	InvokeHelper(0x402, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

double PageSetup::GetRightMargin()
{
	double result;
	InvokeHelper(0x3e8, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutRightMargin(double newValue)
{
	static BYTE parms[] = VTS_R8;
	InvokeHelper(0x3e8, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

double PageSetup::GetTopMargin()
{
	double result;
	InvokeHelper(0x3e9, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutTopMargin(double newValue)
{
	static BYTE parms[] = VTS_R8;
	InvokeHelper(0x3e9, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

VARIANT PageSetup::GetZoom()
{
	VARIANT result;
	InvokeHelper(0x297, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutZoom(VARIANT& newValue)
{
	static BYTE parms[] = VTS_VARIANT;
	InvokeHelper(0x297, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, &newValue);
}

long PageSetup::GetPrintComments()
{
	long result;
	InvokeHelper(0x5f4, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutPrintComments(long newValue)
{
	static BYTE parms[] = VTS_I4;
	InvokeHelper(0x5f4, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

long PageSetup::GetPrintErrors()
{
	long result;
	InvokeHelper(0x865, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutPrintErrors(long newValue)
{
	static BYTE parms[] = VTS_I4;
	InvokeHelper(0x865, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

LPDISPATCH PageSetup::GetCenterHeaderPicture()
{
	LPDISPATCH result;
	InvokeHelper(0x866, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
	return result;
}
...
{
	LPDISPATCH result;
	InvokeHelper(0x867, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
	return result;
}
...
{
	LPDISPATCH result;
	InvokeHelper(0x868, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
	return result;
}
...
{
	LPDISPATCH result;
	InvokeHelper(0x869, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
	return result;
}
...
{
	LPDISPATCH result;
	InvokeHelper(0x86a, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
	return result;
}
...
{
	LPDISPATCH result;
	InvokeHelper(0x86b, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
	return result;
}
...
{
	BOOL result;
	InvokeHelper(0xa28, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutOddAndEvenPagesHeaderFooter(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL;
	InvokeHelper(0xa28, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

BOOL PageSetup::GetDifferentFirstPageHeaderFooter()
{
	BOOL result;
	InvokeHelper(0xa29, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutDifferentFirstPageHeaderFooter(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL;
	InvokeHelper(0xa29, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

BOOL PageSetup::GetScaleWithDocHeaderFooter()
{
	BOOL result;
	InvokeHelper(0xa2a, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutScaleWithDocHeaderFooter(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL;
	InvokeHelper(0xa2a, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

BOOL PageSetup::GetAlignMarginsHeaderFooter()
{
	BOOL result;
	InvokeHelper(0xa2b, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
	return result;
}

void PageSetup::PutAlignMarginsHeaderFooter(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL;
	InvokeHelper(0xa2b, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
}

LPDISPATCH PageSetup::GetPages()
{
	LPDISPATCH result;
	InvokeHelper(0xa2c, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
	return result;
}
...
{
	LPDISPATCH result;
	InvokeHelper(0xa2d, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
	return result;
}
...
{
	LPDISPATCH result;
	InvokeHelper(0xa2e, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
	return result;
}
